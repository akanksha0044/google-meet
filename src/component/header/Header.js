...
const handleImageUpload = async (e) => {
  ...
  return (
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light ">
      ...
      <a className="navbar-brand my-lg" href="/">Google Meet</a>
    </a>
  ...
  <li class="nav-item">
        ...
        <li class="nav-item ">
        <img src='./image/ak.jpg' alt='' className='topImg'  onClick={()=>setShow(!show)}/>
        </li>
</ul>
...
<div className='card-shadow'>
    ...
    <div className='row'>
      ...
      <img src={props.user?.photoURL} alt='' className='topImg2' onClick={() => inputRef.current.click()}/>
  <input type="file" accept="image/*" ref={inputRef} style={{ display: 'none' }} onChange={handleImageUpload}/>
      </div>
      <div className='col-md-10'>
      
      <p>{user ? user.displayName : ''}<br></br>
                            {user ? user.email : ''}</p>
   ...
   <NavLink to='/login'className='text-decoration-none'><div className="card mt-2 ">
<div class="card-body">
<div className='row'>
<div className='col-md-2'>
      <PersonAddAlt1/>
